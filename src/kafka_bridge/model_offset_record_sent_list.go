...
type OffsetRecordSentList struct {
	Offsets []OffsetRecordSentListOffsetsInner `json:"offsets,omitempty"`
}
...
func (o *OffsetRecordSentList) GetOffsets() []OffsetRecordSentListOffsetsInner {
	if o == nil || IsNil(o.Offsets) {
		var ret []OffsetRecordSentListOffsetsInner
		return ret
	}
	return o.Offsets
}
...
// SetOffsets gets a reference to the given []OffsetRecordSentListOffsetsInner and assigns it to the Offsets field.
