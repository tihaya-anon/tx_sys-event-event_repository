...
type ConsumerRecord struct {
	...
	Value NullableRecordValue `json:"value,omitempty"`
...
// SetValue gets a reference to the given NullableRecordValue and assigns it to the Value field.
func (o *ConsumerRecord) SetValue(v RecordValue) {
	o.Value.Set(&v)
}
// SetValueNil sets the value for Value to be an explicit nil
func (o *ConsumerRecord) SetValueNil() {
	o.Value.Set(nil)
}
